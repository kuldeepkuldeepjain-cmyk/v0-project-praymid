...
export async function GET() {
  try {
    ...
    // Create stakes table - WITHOUT foreign key first, add it later after participants table exists
    await query(`
    ...
    // Create staking_rewards table - WITHOUT foreign key first
    await query(`
    ...
    // Create staking_claims table - WITHOUT foreign key first
    await query(`
